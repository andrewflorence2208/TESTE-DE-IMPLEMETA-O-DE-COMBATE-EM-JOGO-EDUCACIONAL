...
function atk(sta, dmg, pc){
    ...
    // IF THERES STAMINA AND THE ENEMY SURVIVE
        ...
        document.getElementById("char_dmg").innerHTML = Math.abs(dmg);
        document.getElementById("char_crt").innerHTML = Math.abs(critical_dmg.toFixed(2));
    ...
    //IF THERES NO STAMINA
        window.alert("TAKE A REST!!! DEFENSE")
    };
...
function def(sta, hp){
    ...
    document.getElementById("char_dmg").innerHTML = "0";
    document.getElementById("char_crt").innerHTML = "0";
...
if(e_life_value > 0){
    ...
    switch(atk_frq > def_frq){
        ...
        case (false):
            ...
            document.getElementById("e_dmg").innerHTML = "0";
            document.getElementById("e_crt").innerHTML = "0";
            break;
    };
